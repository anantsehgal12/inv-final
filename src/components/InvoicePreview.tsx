  ...
  ({ invoice, company }, ref) => {
    ...
    return (
      ...
      >
              ...
              {invoice.items.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className="border px-3 py-2 text-sm" style={{ border: '1px solid #334155' }}>
                    ...
                    <div style={{ color: '#4b5563', fontSize: '12px', marginTop: '4px' }}>{item.description}</div>
            ...
            >
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border px-3 py-2 text-sm text-right" style={{ border: '1px solid #334155' }}>
                    {formatCurrency((invoice.subtotal - (invoice.discount || 0)) + (invoice.additionalCharges?.reduce((sum, ch) => sum + ch.amount, 0) || 0))}
                  </td>
                </tr>
        ...
        {/* Footer */}
        <div className="border-t pt-4" style={{ borderTopColor: '#334155', borderTopWidth: '1px', borderStyle: 'solid' }}>
